            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Air Conditioner</h3>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Refrigerator</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Washing machine</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Microwave oven</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Water purifier</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Electrician</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Home Painter</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Civil contractor</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Interior Designer</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Vastu Shastra Consultant</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
                ...
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                       <a href="#">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Bathroom Accessories & Sanitary ware Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Hardware & Plywood Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Electrical Material Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
                ...
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                       <a href="#">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Glass Window & Doors  Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Granite & Tiles Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Car Repair</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Bike Repair</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Computer Repair</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">CCTV Camera</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Room cooler</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Water Dispenser</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Air Cooler</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Water cooler</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Deep Freezer</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Home Automation Dealers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Movers and packers</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                <ul class="category-subservice-list">
                    <li class=" hoverable valign-wrapper">
                        ...
                        <span >
                           <span>
                              <h3 itemprop="name">Home Construction</h3>
                              <span itemprop="description" style="display:none"></span>
                           </span>
                        </span>
