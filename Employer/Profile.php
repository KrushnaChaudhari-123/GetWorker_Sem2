            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-Label="Employer Id"> <?php echo $row['EmployerId'];?></td>
                        <td data-Label="Contact Person"> <?php echo $row['ContactPerson'];?> </td>
                        ...
                        <td data-Label="Edit Profile"> <a href="EditPro.php?EmployerId=<?php echo $row['EmployerId']; ?>">Click Here</a> </td>
